...
function resolveCompetitorName(competitor) {
...
export function buildSourcesForCompetitors(competitors) {
  ...
  competitors.forEach((competitor) => {
    ...
    if (!mapping) {
      console.warn(`[competitor-mapping] No source mapping found for competitor: ${competitor}`);
      return;
    }
    
    const competitorId = resolvedCompetitor.toLowerCase().replace(/\s+/g, '-');
